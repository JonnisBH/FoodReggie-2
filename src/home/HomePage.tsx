...
const HomePage: React.FC = () => {
    ...
    return(
        <div className="tw-outline tw-outline-1 tw-outline-offset-0 tw-outline-gray-300 tw-mx-28 tw-my-6 tw-shadow-2xl tw-rounded-lg">
            <div className="tw-flex tw-w-full tw-h-screen">
                <div className="tw-basis-4/6 tw-flex tw-flex-col tw-space-y-3 tw-justify-center tw-items-start tw-backdrop-invert tw-rounded-l-lg">
